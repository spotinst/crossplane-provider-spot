...
export TERRAFORM_PROVIDER_VERSION := 1.195.0
...
REGISTRY_ORGS ?= xpkg.upbound.io/spot-by-netapp
IMAGES = $(PROJECT_NAME)
...
XPKG_REG_ORGS ?= xpkg.upbound.io/spot-by-netapp
# NOTE(hasheddan): skip promoting on xpkg.upbound.io as channel tags are
# inferred.
XPKG_REG_ORGS_NO_PROMOTE ?= xpkg.upbound.io/spot-by-netapp
XPKGS = $(PROJECT_NAME)
...
xpkg.build.crossplane-provider-spot: do.build.images
...
#   You can check the basic implementation here: https://github.com/crossplane/uptest/blob/main/internal/spots/03-delete.yaml.tmpl.
