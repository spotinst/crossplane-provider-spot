...
type OceanGkeLaunchSpecInitParameters struct {
...
type OceanGkeLaunchSpecObservation struct {
...
type OceanGkeLaunchSpecParameters struct {
...
// OceanGkeLaunchSpecSpec defines the desired state of OceanGkeLaunchSpec
type OceanGkeLaunchSpecSpec struct {
	v1.ResourceSpec `json:",inline"`
	ForProvider     OceanGkeLaunchSpecParameters `json:"forProvider"`
	...
	// autoscaler.
	InitProvider OceanGkeLaunchSpecInitParameters `json:"initProvider,omitempty"`
}

// OceanGkeLaunchSpecStatus defines the observed state of OceanGkeLaunchSpec.
type OceanGkeLaunchSpecStatus struct {
	v1.ResourceStatus `json:",inline"`
	AtProvider        OceanGkeLaunchSpecObservation `json:"atProvider,omitempty"`
}
...
// OceanGkeLaunchSpec is the Schema for the OceanGkeLaunchSpecs API. Provides a Spotinst Ocean Launch Spec resource using GKE.
...
type OceanGkeLaunchSpec struct {
	...
	Spec   OceanGkeLaunchSpecSpec   `json:"spec"`
	Status OceanGkeLaunchSpecStatus `json:"status,omitempty"`
}

// +kubebuilder:object:root=true

// OceanGkeLaunchSpecList contains a list of OceanGkeLaunchSpecs
type OceanGkeLaunchSpecList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []OceanGkeLaunchSpec `json:"items"`
}

// Repository type metadata.
var (
	OceanGkeLaunchSpec_Kind             = "OceanGkeLaunchSpec"
	OceanGkeLaunchSpec_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: OceanGkeLaunchSpec_Kind}.String()
	OceanGkeLaunchSpec_KindAPIVersion   = OceanGkeLaunchSpec_Kind + "." + CRDGroupVersion.String()
	OceanGkeLaunchSpec_GroupVersionKind = CRDGroupVersion.WithKind(OceanGkeLaunchSpec_Kind)
)

func init() {
	SchemeBuilder.Register(&OceanGkeLaunchSpec{}, &OceanGkeLaunchSpecList{})
}
