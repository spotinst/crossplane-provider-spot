...
func (in *AutoUpdateInitParameters) DeepCopyInto(out *AutoUpdateInitParameters) {
	*out = *in
	if in.IsEnabled != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new AutoUpdateInitParameters.
func (in *AutoUpdateInitParameters) DeepCopy() *AutoUpdateInitParameters {
	if in == nil {
		return nil
	}
	out := new(AutoUpdateInitParameters)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *AutoUpdateObservation) DeepCopyInto(out *AutoUpdateObservation) {
	*out = *in
	if in.IsEnabled != nil {
		in, out := &in.IsEnabled, &out.IsEnabled
		*out = new(bool)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new AutoUpdateObservation.
func (in *AutoUpdateObservation) DeepCopy() *AutoUpdateObservation {
	if in == nil {
		return nil
	}
	out := new(AutoUpdateObservation)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *AutoUpdateParameters) DeepCopyInto(out *AutoUpdateParameters) {
	*out = *in
	if in.IsEnabled != nil {
		in, out := &in.IsEnabled, &out.IsEnabled
		*out = new(bool)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new AutoUpdateParameters.
func (in *AutoUpdateParameters) DeepCopy() *AutoUpdateParameters {
	if in == nil {
		return nil
	}
	out := new(AutoUpdateParameters)
	in.DeepCopyInto(out)
	return out
}
...
func (in *OceanGkeInitParameters) DeepCopyInto(out *OceanGkeInitParameters) {
	*out = *in
	if in.AutoUpdate != nil {
		...
		*out = make([]AutoUpdateInitParameters, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *OceanGkeObservation) DeepCopyInto(out *OceanGkeObservation) {
	*out = *in
	if in.AutoUpdate != nil {
		in, out := &in.AutoUpdate, &out.AutoUpdate
		*out = make([]AutoUpdateObservation, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *OceanGkeParameters) DeepCopyInto(out *OceanGkeParameters) {
	*out = *in
	if in.AutoUpdate != nil {
		in, out := &in.AutoUpdate, &out.AutoUpdate
		*out = make([]AutoUpdateParameters, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
