...
```
up ctp provider install xpkg.upbound.io/spot-by-netapp/crossplane-provider-spot:v0.9.0
```
...
spec:
  package: xpkg.upbound.io/spot-by-netapp/crossplane-provider-spot:v0.9.0
EOF
```
